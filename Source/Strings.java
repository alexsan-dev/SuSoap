...
public class Strings {
  ...
  public String[] warnings = { "", "Opcion no permitida, intenta de nuevo",
      ...
      "Palabra encontrada!, obtienes puntos", "Aun no existen perdedores", "Aun no existen ganadores",
      "Aun no existen partidas registradas" };

  // TEXTOS DE MENUS
  private String exitString = " ( 0 para salir )";
